    ...
    <html lang="en">
      ...
      <body>
        <div className="flex flex-col h-full justify-items-center lg:grid lg:grid-cols-main lg:grid-rows-main">
          ...
          <aside className="bg-mainLight hidden w-full lg:col-start-2 lg:col-end-2 lg:row-start-2 lg:row-end-3 lg:flex lg:h-full lg:flex-col lg:items-center lg:border-l-2 lg:border-l-mainLight lg:px-2 lg:pt-6">
